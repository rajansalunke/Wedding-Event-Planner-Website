...
<head>
 ...
 <!--[if lt IE 9]>
  ...
  <![endif]-->
   ...
   <style type="">.feature-item .content{
	background: #cfbbbb;
    box-shadow: 1px 1px 30px 1px cadetblue;
    border-radius: 10px;
}
.info{
	color: black;
		      ...
		      <div class="carousel-inner">
		        <div class="item active" style="background-image: url(img/slider/011.jpg)">
		        	<div class="col-sm-offset-1 caption caption-wide">
		        		<h1 class="main-title wow fadeInUp" data-wow-delay=".25s "> </br>Our<br/>Best<br/>Services</h1>
				...
				<div class="row">
					...
					<div class="col-md-4 feature-item">
						<div class="content wow fadeInDown" data-wow-delay=".15s">
							<p class="icon text-center"> <img src="img/blog/a1.png"> </p>
							<h5 class="title text-center">Weddings </h5>
							<p class="info">
								Make the day you've always dreamed of, the day you'll never forget.
							</p>
						</div>
					</div>
					<div class="col-md-4 feature-item">
						<div class="content wow fadeInDown" data-wow-delay=".35s">
							<p class="icon text-center"><img src="img/blog/a2.jpg"></i></p>
							<h5 class="title text-center">Corporate events</h5>
							<p class="info">
								Wow your guests with a unique event that aligns with your company's vision.
						</div>
					</div>
					<div class="col-md-4 feature-item">
						<div class="content wow fadeInDown" data-wow-delay=".55s">
							<p class="icon text-center"><img src="img/blog/a3.jpg"></i></p>
							<h5 class="title text-center">Birthdays and parties</h5>
							<p class="info">
								Receptions, rehearsal dinners, birthday parties and more.
							</p>
						</div>
					</div>
				</div> <!-- //row -->
...
<section id="join-us">
			<div class="color-overlay ptb100">
				<div class="container">
<!-- 					<h6  class="section-title wow fadeInDown" style="font-weight: small"> UNPARRALLELED AND STRESSED FREE</h6>
 -->					<h3 class="section-title wow fadeInDown">Event Planning and Design</h3>
					<p class="section-info col-sm-8 col-sm-offset-2 wow fadeInDown" data-wow-delay=".25s" style="color: black"; style="font-weight: bold;">
