      ...
      <div id="home-slider" class="carousel slide in" data-ride="carousel">
        <!-- Indicators -->
          ...
          <div class="carousel-inner">
            <div class="item active" style="background-image: url(img/slider/001.jpg)">
              <div class="col-sm-offset-1 caption caption-wide">
                <h1 class="main-title wow fadeInUp" data-wow-delay=".25s "><br/><br/>About<br/>Us</h1>
...
<SECTION>
                <div class="container one">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                      <h1 class="he" style="font-weight: bold"><br><br> PLANNER </h1><br><br> <h1 class="he" style="color: crimson">PLANS YOUR EVENTS.</h1>
                    </div>

                    <div class="col-sm-6">
                      <p class="pe">Founded in 2011, Planner Hospitality was created out of a love for dynamic events and fine dining. Our goal is to provide unparalleled event services and outstanding customer service.

Why Planner? Because with us, there are infinite possibilities. Big or small, we are committed to creating one-of-a-kind events that your guests will remember for years to come. Customization is guaranteed, from your floor plan to your bar menu and signature lounge furniture.

We work with the best vendors in the Nashville area to provide planning and design services at the venue of your dreams, and we also offer full services at The Bridge Building Event Spaces, The Bell Tower, and The Estate at Cherokee Dock through exclusive venue management and in-house catering.</p>
                    </div>
                  </div>
                </div>
